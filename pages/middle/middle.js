...
Page({
  ...
  data: {
    ...
    food_recordMine_Page: new Array(),
    list_food_Search: new Array(),
    index_page: 0,
    counter_TwoStarL:0,
    maximum:5,
  ...
  PageSwitch: function(event){
    ...
    this.data.food_recordMine_Page[0]=event.currentTarget.dataset.index;

    this.setData({
      food_recordMine_Page: this.data.food_recordMine_Page
    })
    
    getApp().globalData.list_food_page=this.data.food_recordMine_Page; 
    console.log(getApp().globalData.list_food_page[0]);
